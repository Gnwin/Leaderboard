...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _stylesheets_reset_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../stylesheets/reset.css */ \"./src/assets/stylesheets/reset.css\");\n/* harmony import */ var _stylesheets_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../stylesheets/style.css */ \"./src/assets/stylesheets/style.css\");\n/* harmony import */ var _modules_Games__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Games */ \"./src/assets/js/modules/Games.js\");\n/* harmony import */ var _modules_GrabUserInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/GrabUserInput */ \"./src/assets/js/modules/GrabUserInput.js\");\n/* harmony import */ var _modules_fetchdata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/fetchdata */ \"./src/assets/js/modules/fetchdata.js\");\n/* harmony import */ var _modules_loader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/loader */ \"./src/assets/js/modules/loader.js\");\n/* harmony import */ var _modules_CreateGame__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/CreateGame */ \"./src/assets/js/modules/CreateGame.js\");\n\n\n\n\n\n\n\n\n// import Icon from './images/icon.png';\n\nif (_modules_Games__WEBPACK_IMPORTED_MODULE_2__[\"default\"].games.length === 0) {\n  const scorelist = document.querySelector('.scores');\n  scorelist.innerHTML = _modules_loader__WEBPACK_IMPORTED_MODULE_5__[\"default\"];\n}\n\n(0,_modules_CreateGame__WEBPACK_IMPORTED_MODULE_6__[\"default\"])().then((uniqueid) => {\n  (0,_modules_fetchdata__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(uniqueid);\n  const btn = document.querySelector('.submit');\n  const refresh = document.querySelector('.refresh');\n\n  const makeHandler1 = (id) => (event) => {\n    _modules_GrabUserInput__WEBPACK_IMPORTED_MODULE_3__[\"default\"].refresh(event, id);\n  };\n  refresh.addEventListener('click', makeHandler1(uniqueid)); \n\n  const makeHandler = (id) => (event) => {\n    _modules_GrabUserInput__WEBPACK_IMPORTED_MODULE_3__[\"default\"].creategame(event, id);\n  };\n  btn.addEventListener('click', makeHandler(uniqueid));\n});\n\n\n\n\n\n//# sourceURL=webpack://leaderboard/./src/assets/js/index.js?");
...
/***/ "./src/assets/js/modules/CreateGame.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/CreateGame.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Api */ \"./src/assets/js/modules/Api.js\");\n/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Game */ \"./src/assets/js/modules/Game.js\");\n\n\n\nconst gamename = 'My cool new game';\nconst game = new _Game__WEBPACK_IMPORTED_MODULE_1__[\"default\"](gamename);\n\nfunction createGame() {\n  return fetch(_Api__WEBPACK_IMPORTED_MODULE_0__[\"default\"], {\n    method: 'POST',\n    body: JSON.stringify(game),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n  })\n  .then((response) => response.json())\n  .then((json) => {\n    let id;\n    const splittedResult = json.result.split(' ');\n    id = splittedResult[3];\n    const scores = document.querySelector('.scores');\n    scores.setAttribute(\"id\", id);\n    return id;\n  })\n\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createGame);\n\n//# sourceURL=webpack://leaderboard/./src/assets/js/modules/CreateGame.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _fetchdata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchdata */ \"./src/assets/js/modules/fetchdata.js\");\n/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Api */ \"./src/assets/js/modules/Api.js\");\n/* harmony import */ var _Newgame__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Newgame */ \"./src/assets/js/modules/Newgame.js\");\n\n\n\n\nclass GrabUserInput {\n  creategame = (e, id) => {\n    e.preventDefault();\n    const name = document.querySelector('.yourname');\n    const score = document.querySelector('.yourscore');\n\n    if (name.value === '' && score.value === '') {\n      return;\n    }\n\n    const game = new _Newgame__WEBPACK_IMPORTED_MODULE_2__[\"default\"](name.value, score.value);\n    name.value = '';\n    score.value = '';\n    fetch(`${_Api__WEBPACK_IMPORTED_MODULE_1__[\"default\"]}/${id}/scores`, {\n      method: 'POST',\n      body: JSON.stringify(game),\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8',\n      },\n    })\n    .then((response) => response.json())\n    .then((json) => {\n      // console.log(json);\n    });\n\n  }\n\n  refresh = (e, id) => {\n    e.preventDefault();\n    (0,_fetchdata__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(id);\n  }\n}\n\nconst grabinput = new GrabUserInput();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (grabinput);\n\n\n\n//# sourceURL=webpack://leaderboard/./src/assets/js/modules/GrabUserInput.js?");
...
/***/ "./src/assets/js/modules/fetchdata.js":
/*!********************************************!*\
  !*** ./src/assets/js/modules/fetchdata.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _Games__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Games */ \"./src/assets/js/modules/Games.js\");\n/* harmony import */ var _Displaygames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Displaygames */ \"./src/assets/js/modules/Displaygames.js\");\n/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./error */ \"./src/assets/js/modules/error.js\");\n\n\n\n\n\nasync function getGames(id) {\n  const response = await fetch(\n    `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${id}/scores`\n  );\n  const data = await response.json();\n  if (!response.ok) {\n    throw new Error(response.statusText);\n  }\n  return data;\n}\n\nconst fetchdata = async (gameid) => {\n  let data = await getGames(gameid);\n  _Games__WEBPACK_IMPORTED_MODULE_0__[\"default\"].games = data.result;\n  _Displaygames__WEBPACK_IMPORTED_MODULE_1__[\"default\"].gamedata(_Games__WEBPACK_IMPORTED_MODULE_0__[\"default\"].games);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fetchdata);\n\n//# sourceURL=webpack://leaderboard/./src/assets/js/modules/fetchdata.js?");
